...
public class Movement_Controller : MonoBehaviour
{
    ...
    public bool _morejumps = false;
    public bool _canbemorejumps = false;
    public int jumps = 0;
    ...
    public void MoreJumps(bool more)
    {
        _morejumps = more;
        _canbemorejumps = more;
    }
